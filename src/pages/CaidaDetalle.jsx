...
export default function CaidaDetalle() {
  ...
  // Hidrata Dexie con estado fresco desde Supabase al abrir la caída
  useEffect(() => {
        ...
        {PROTOCOLOS.map(protocolo => {
          ...
          return (
            <div
              ...
              onClick={esG5 ? undefined : () => navigate(`/protocolo/caida/${caidaId}/${protocolo.id}`)}
            >
